    ...
    <div className="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3 duration-300 hover:-translate-y-1">
      <article className="overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="grid items-center justify-between leading-tight p-2 md:p-4">
          ...
          <div className=" text-black pt-1 font-light">Years of experience: {year_experiences}</div>
          <div className=" text-black pt-1 font-light">Numbers of recipes: {num_Recipe}</div>
          <div className=" text-black pt-1 font-light">Likes: {liked_items}</div>
        </div>
